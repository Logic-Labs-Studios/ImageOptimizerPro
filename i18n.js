const translations = {
    pt: {
        ...
        "blog_placeholder_a1": "Foguetão / Velocímetro SEO",
        "blog_a1_p1": "O tempo de carregamento de uma página web é um fator crítico para o sucesso online. O Google utiliza os Core Web Vitals para classificar sites, e as imagens pesadas são o principal inimigo do desempenho. Fazer a <strong class=\"text-gray-800\">otimização de imagens para web</strong> não é apenas um luxo, é uma necessidade para garantir um bom ranking no Google.",
        "blog_a1_p2": "Ao utilizar um <strong class=\"text-gray-800\">compressor de imagens online</strong>, consegue reduzir o peso dos ficheiros até 80% sem qualquer perda percetível de qualidade visual. Isto garante uma velocidade de carregamento rápida, diminuindo a taxa de rejeição (bounce rate) dos visitantes. Sites mais leves consomem menos largura de banda, sendo cruciais para a navegação em dispositivos móveis. A nossa ferramenta de <strong class=\"text-gray-800\">compressão de fotos grátis</strong> processa tudo no seu navegador, garantindo que o seu site cumpre as exigências técnicas dos motores de busca de forma imediata e segura.",
        
        "blog_a2_title": "JPEG, PNG, WebP ou AVIF: Qual o Melhor Formato de Imagem?",
        "blog_placeholder_a2": "Comparação de Formatos de Imagem",
        "blog_a2_p1": "Escolher a extensão correta para as suas fotografias pode ser confuso. A <strong class=\"text-gray-800\">conversão de formato de imagem</strong> é o primeiro passo para um site profissional. O <strong class=\"text-gray-800\">formato JPEG</strong> é clássico e excelente para fotografias complexas, oferecendo um bom rácio de compressão. Já o PNG é indispensável quando precisa de imagens com fundo transparente, como logótipos ou gráficos vetoriais.",
        "blog_a2_p2": "No entanto, a web moderna exige mais. O <strong class=\"text-gray-800\">formato WebP</strong>, desenvolvido pelo Google, e o formato de nova geração AVIF, oferecem qualidades superiores com tamanhos de ficheiro significativamente menores. Utilizar um <strong class=\"text-gray-800\">conversor de imagens HEIC para JPG</strong> ou transformar as suas fotos em WebP garante compatibilidade total e máxima eficiência. Com o nosso conversor online gratuito, pode transitar entre estes formatos num clique, sem instalar qualquer software, melhorando a experiência do utilizador e o desempenho global do seu projeto.",

        "blog_a3_title": "O Guia Prático para Redimensionar Imagens para Redes Sociais e Impressão",
        "blog_placeholder_a3": "Grelha de design Instagram / Facebook",
        "blog_a3_p1": "Cada plataforma digital tem as suas próprias regras. Fazer o upload de uma imagem com o tamanho errado resulta num recorte automático desastroso ou numa compressão que destrói a nitidez. Saber como <strong class=\"text-gray-800\">redimensionar fotos online</strong> com as proporções exatas é vital para criadores de conteúdo e profissionais de marketing.",
        "blog_a3_p2": "Seja para adaptar uma foto para o formato retrato do Instagram (1080x1350), criar uma capa perfeita para o Facebook, ou preparar aquele design incrível para impressões de t-shirts a 4500 X 5400 píxeis, usar as medidas corretas evita dores de cabeça. Um bom <strong class=\"text-gray-800\">redimensionador e recortador de imagens</strong> permite manter a proporção da foto ou aplicar um crop específico. Utilize o nosso <strong class=\"text-gray-800\">redimensionador de imagem sem perda de qualidade</strong> para garantir que as suas publicações, campanhas e produtos físicos têm sempre um aspeto incrivelmente profissional.",
    ...
    en: {
        ...
        "blog_a1_title": "How Image Compression Improves Your Website's SEO and Speed",
        "blog_placeholder_a1": "SEO Rocket / Speedometer",
        "blog_a1_p1": "Website loading time is a critical factor for online success. Google uses Core Web Vitals to rank sites, and heavy images are the main enemy of performance. Doing <strong class=\"text-gray-800\">image optimization for the web</strong> is not just a luxury; it is a necessity to guarantee a good ranking on Google.",
        "blog_a1_p2": "By using an <strong class=\"text-gray-800\">online image compressor</strong>, you can reduce file sizes up to 80% with no perceptible visual quality loss. This guarantees blazing-fast loading speeds, reducing visitor bounce rates. Lighter sites consume less bandwidth, which is crucial for mobile browsing. Our <strong class=\"text-gray-800\">free photo compression</strong> tool processes everything inside your browser, ensuring your website meets the search engines' technical demands instantly and securely.",
        
        "blog_a2_title": "JPEG, PNG, WebP or AVIF: Which is the Best Image Format?",
        "blog_placeholder_a2": "Image Format Comparison",
        "blog_a2_p1": "Choosing the correct file extension for your photographs can be confusing. An <strong class=\"text-gray-800\">image format conversion</strong> is the first step for a professional site. The <strong class=\"text-gray-800\">JPEG format</strong> is a classic and excellent choice for complex photos, offering a great compression ratio. Conversely, PNG is indispensable when you need images with a transparent background, such as logos or vector graphics.",
        "blog_a2_p2": "However, the modern web demands more. The <strong class=\"text-gray-800\">WebP format</strong>, developed by Google, and the next-generation AVIF format, provide superior quality with significantly lower file sizes. Using a <strong class=\"text-gray-800\">HEIC to JPG converter</strong> or turning your photos into WebP guarantees total compatibility and maximum efficiency. With our free online converter, you can switch between these formats with one click without installing any software, improving user experience and your project's overall performance.",

        "blog_a3_title": "The Practical Guide to Resizing Images for Social Media and Print",
        "blog_placeholder_a3": "Instagram / Facebook Design Grid",
        "blog_a3_p1": "Every digital platform has its own rules. Uploading an image to the web with the wrong size results in disastrous auto-cropping or compression that destroys its sharpness. Knowing how to <strong class=\"text-gray-800\">resize photos online</strong> to exact proportions is vital for content creators and marketers.",
        "blog_a3_p2": "Whether it is adjusting a photo to an Instagram portrait format (1080x1350), making the perfect Facebook cover, or preparing that incredible t-shirt print design at 4500 X 5400 pixels, using correct measurements prevents headaches. A good <strong class=\"text-gray-800\">image resizer and cropper</strong> allows you to lock proportions or apply specific cropping. Use our <strong class=\"text-gray-800\">lossless image resizer</strong> to ensure your social posts, marketing campaigns, and physical products look incredibly professional every single time.",
